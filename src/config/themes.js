...
export const getTheme = (isDark) => ({
  ...
  input: isDark ? 'bg-[#1a1a1a] border-[#444] text-white focus:border-white' : 'bg-white border-slate-300 text-slate-900 focus:border-blue-500',
  ...
  accent1: isDark ? 'text-white' : 'text-blue-600',
  accent2: isDark ? 'text-[#ffcc00]' : 'text-amber-600',
  accentBg: isDark ? 'bg-white text-black hover:bg-gray-200 shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'bg-blue-600 text-white hover:bg-blue-700',
  btnPrimary: isDark ? 'bg-[#ffcc00] text-black hover:bg-white' : 'bg-blue-600 text-white hover:bg-blue-700',
