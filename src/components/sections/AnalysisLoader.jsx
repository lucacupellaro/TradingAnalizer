...
export const AnalysisLoader = ({ isAnalyzing, formulaIdx, isDark, theme, rowStart, rowEnd }) => {
  ...
  return (
    <div className={`fixed inset-0 z-[9999] ${isDark ? 'bg-black/90' : 'bg-white/90'} backdrop-blur-sm flex flex-col items-center justify-center font-mono`}>
      <Activity className={`w-16 h-16 animate-spin mb-12 ${theme.accent2}`} />
      <h2 className={`text-2xl md:text-3xl font-black uppercase tracking-widest mb-10 animate-pulse ${theme.accent1}`}>
      ...
      <div className="mt-10 text-center break-words">
